...
Widget getAdditionalButtonsForManga(Manga manga, BuildContext context, Function() resetState, bool isWishlist) {
  return Row(
    children: [
      Container(
        // Settings button
        ...
        child: IconButton(
          onPressed: () {
            showSettingsDialog(manga, context, resetState, isWishlist);
          },
          icon: const Icon(
            Icons.settings,
            color: Colors.white,
